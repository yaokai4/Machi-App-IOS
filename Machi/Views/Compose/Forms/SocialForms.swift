...
struct MeetupFormView: View {
    ...
    var body: some View {
        TypedFormSection(titleKey: "ct_meetup", icon: "hand.wave") {
            ...
            TypedTextField("fld_meetup_type", text: viewModel.stringBinding(PostAttributeKeys.meetupType), isRequired: true)
            TypedTextField("fld_meetup_time", text: viewModel.stringBinding(PostAttributeKeys.meetupTime), isRequired: true)
            TypedTextField("fld_location", text: viewModel.stringBinding(PostAttributeKeys.location), isRequired: true)
            TypedTextField("fld_people_limit", text: viewModel.intBinding(PostAttributeKeys.peopleLimit), keyboard: .numberPad, isRequired: true)
...
struct DiningFormView: View {
    ...
    var body: some View {
        TypedFormSection(titleKey: "ct_dining", icon: "fork.knife") {
            ...
            TypedTextField("fld_meetup_time", text: viewModel.stringBinding(PostAttributeKeys.meetupTime), isRequired: true)
            TypedTextField("fld_people_limit", text: viewModel.intBinding(PostAttributeKeys.peopleLimit), keyboard: .numberPad, isRequired: true)
            TypedTextField("fld_budget", text: viewModel.stringBinding(PostAttributeKeys.budget), isRequired: true)
            TypedTextField("fld_description", text: viewModel.stringBinding(PostAttributeKeys.description), axis: .vertical)
        }
    }
}
...
struct EventFormView: View {
    ...
    var body: some View {
        TypedFormSection(titleKey: "ct_event", icon: "calendar") {
            TypedTextField("fld_title", text: viewModel.stringBinding(PostAttributeKeys.title), isRequired: true)
            TypedTextField("fld_event_time", text: viewModel.stringBinding(PostAttributeKeys.eventTime), isRequired: true)
            TypedTextField("fld_location", text: viewModel.stringBinding(PostAttributeKeys.location), isRequired: true)
